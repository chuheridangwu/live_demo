...
@property(readwrite, retain, nonatomic) GPU_GLProgram *currentShaderProgram;
...
+ (void)setActiveShaderProgram:(GPU_GLProgram *)shaderProgram;
- (void)setContextShaderProgram:(GPU_GLProgram *)shaderProgram;
...
- (GPU_GLProgram *)programForVertexShaderString:(NSString *)vertexShaderString fragmentShaderString:(NSString *)fragmentShaderString;

...
@protocol outRunQueueDelegate<NSObject>
...
@property (nonatomic,weak)id<outRunQueueDelegate> runQueueDelegate;
...
- (id)initWithMovieURL:(NSURL *)newMovieURL size:(CGSize)newSize fileType:(NSString *)newFileType outputSettings:(NSMutableDictionary *)outputSettings runQueueDelegate:(id<outRunQueueDelegate>)runQueueDelegate;
...
- (void)pushPixel:(CVPixelBufferRef)pixel time:(CMTime)frameTime;

...
#import "GPUImageFourInputFilterI.h"

NSString *const kGPUImageFourInputTextureVertexShaderStringI = SHADER_STRING
(
...
@implementation GPUImageFourInputFilterI

#pragma mark - Initialization and teardown

- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString
{
    if (!(self = [self initWithVertexShaderFromString:kGPUImageFourInputTextureVertexShaderStringI fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }

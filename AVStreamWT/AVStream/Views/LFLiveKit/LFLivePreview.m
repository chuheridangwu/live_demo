...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [self performSelector:@selector(requestAccessForVideo) withObject:nil afterDelay:1];
    }
    return self;
}
...
- (LFLiveSession *)session {
    if (!_session) {
        ...
        _session.warterMarkView = viewWater;
        /**    自己定制单声道  */
        /*
    ...
    if (!_startLiveButton) {
        ...
        [_startLiveButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            ...
            if (_self.startLiveButton.selected) {
                ...
                stream.url = @"rtmp://129.227.156.179/live/702269646_1648544283?vhost=pushbs.overseaslive.com&wsSecret=1c948a97fe3f6b88a3371d3f8d4b6c96&wsTime=1648544283&sid=2210&stream=702269646&wsPRI=1";
            
//            rtmp://192.168.160.136/des
//            rtmp://192.168.160.136/des
